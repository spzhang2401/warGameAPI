...
class automaticWar:
    ...
    def playTurn (self):
        ...
        if (cardA > cardB and cardA != 2 and cardB != 2):
            self.aCards.append(cardA)
            self.aCards.append(cardB)

        elif (cardA < cardB and cardA != 2 and cardB != 2):
